...
extern int	ffv_yyparse(NDBOX **result);
extern void ffv_yyerror(NDBOX **result, const char *message);
extern void ffv_scanner_init(const char *str);
extern void ffv_scanner_finish(void);

/*
** Input/Output routines
*/
PG_FUNCTION_INFO_V1(ffv_in);
PG_FUNCTION_INFO_V1(ffv_a_f8_f8);
PG_FUNCTION_INFO_V1(ffv_a_f8);
PG_FUNCTION_INFO_V1(ffv_out);
PG_FUNCTION_INFO_V1(ffv_f8);
PG_FUNCTION_INFO_V1(ffv_f8_f8);
PG_FUNCTION_INFO_V1(ffv_c_f8);
PG_FUNCTION_INFO_V1(ffv_c_f8_f8);
PG_FUNCTION_INFO_V1(ffv_dim);
PG_FUNCTION_INFO_V1(ffv_ll_coord);
PG_FUNCTION_INFO_V1(ffv_ur_coord);
PG_FUNCTION_INFO_V1(ffv_subset);

/*
** GiST support methods
*/

PG_FUNCTION_INFO_V1(g_ffv_consistent);
PG_FUNCTION_INFO_V1(g_ffv_compress);
PG_FUNCTION_INFO_V1(g_ffv_decompress);
PG_FUNCTION_INFO_V1(g_ffv_penalty);
PG_FUNCTION_INFO_V1(g_ffv_picksplit);
PG_FUNCTION_INFO_V1(g_ffv_union);
PG_FUNCTION_INFO_V1(g_ffv_same);

/*
** B-tree support functions
*/
PG_FUNCTION_INFO_V1(ffv_eq);
PG_FUNCTION_INFO_V1(ffv_ne);
PG_FUNCTION_INFO_V1(ffv_lt);
PG_FUNCTION_INFO_V1(ffv_gt);
PG_FUNCTION_INFO_V1(ffv_le);
PG_FUNCTION_INFO_V1(ffv_ge);
PG_FUNCTION_INFO_V1(ffv_cmp);

/*
** R-tree support functions
*/

PG_FUNCTION_INFO_V1(ffv_contains);
PG_FUNCTION_INFO_V1(ffv_contained);
PG_FUNCTION_INFO_V1(ffv_overlap);
PG_FUNCTION_INFO_V1(ffv_union);
PG_FUNCTION_INFO_V1(ffv_inter);
PG_FUNCTION_INFO_V1(ffv_size);

/*
** miscellaneous
*/
PG_FUNCTION_INFO_V1(ffv_distance);
PG_FUNCTION_INFO_V1(ffv_is_point);
PG_FUNCTION_INFO_V1(ffv_enlarge);

/*
** For internal use only
*/
int32		ffv_cmp_v0(NDBOX *a, NDBOX *b);
bool		ffv_contains_v0(NDBOX *a, NDBOX *b);
bool		ffv_overlap_v0(NDBOX *a, NDBOX *b);
NDBOX	   *ffv_union_v0(NDBOX *a, NDBOX *b);
void		rt_ffv_size(NDBOX *a, double *sz);
NDBOX	   *g_ffv_binary_union(NDBOX *r1, NDBOX *r2, int *sizep);
bool		g_ffv_leaf_consistent(NDBOX *key, NDBOX *query, StrategyNumber strategy);
bool		g_ffv_internal_consistent(NDBOX *key, NDBOX *query, StrategyNumber strategy);
...
Datum
ffv_in(PG_FUNCTION_ARGS)
{
	char	   *str = PG_GETARG_CSTRING(0);
	NDBOX	   *result;

	ffv_scanner_init(str);

	if (ffv_yyparse(&result) != 0)
		ffv_yyerror(&result, "bogus input");
